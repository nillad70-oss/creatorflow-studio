  ...
  return (
    <>
      ...
      <div style={{ position: 'fixed', inset: 0, background: '#000', overflow: 'hidden' }}>
        ...
        {/* TOP BAR — when camera active */}
        {cameraActive && (
          <div style={{
            position: 'absolute', top: 0, left: 0, right: 0,
            zIndex: 5, padding: '48px 20px 16px',
        ...
        {cameraActive && showSettings && (
          <div style={{
            ...
            zIndex: 8, background: 'rgba(0,0,0,0.85)',
            borderRadius: '16px', padding: '16px', width: '200px',
            ...
            <div>
              ...
              <input type="range" min="16" max="56" value={fontSize}
        ...
        {/* BOTTOM CONTROLS — when camera active */}
        {cameraActive && (
          <div style={{
            position: 'absolute', bottom: 0, left: 0, right: 0,
            zIndex: 5, padding: '16px 32px 48px',
            display: 'flex', alignItems: 'center', justifyContent: 'space-around',
            background: 'linear-gradient(to top, rgba(0,0,0,0.7), transparent)'
          }}>
            {/* Reset */}
            <button onClick={resetScroll} style={{
            ...
            <button onClick={() => setIsPlaying(p => !p)} style={{
              width: '52px', height: '52px', borderRadius: '50%',
              background: isPlaying ? 'rgba(59,130,246,0.8)' : 'rgba(0,0,0,0.5)',
        ...
        {!cameraActive && (
          <div style={{
            ...
            <div style={{ flex: 1, padding: '24px', display: 'flex', flexDirection: 'column', gap: '20px', overflowY: 'auto' }}>
              {/* Script input */}
              <div>
                <label style={{ color: '#888', fontSize: '11px', textTransform: 'uppercase', letterSpacing: '2px', display: 'block', marginBottom: '8px' }}>
                  Your Script
                </label>
                <textarea
                  value={script}
                  ...
                  style={{
                    ...
                    fontSize: '14px', resize: 'none', boxSizing: 'border-box', lineHeight: 1.6
                  }}
                />
              </div>
              ...
              <p style={{ color: '#555', fontSize: '12px', textAlign: 'center' }}>
                Camera will fill your screen. Script overlays on top.
              </p>
            </div>
          </div>
        )}
