...
export default function Terms() {
  return (
    <>
      <Head>
        <title>Terms of Service — CreatorFlow Studio™</title>
      </Head>
      <div style={{ minHeight: '100vh', background: '#050505', color: 'white', padding: '40px 24px' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          ...
          <div style={{ lineHeight: '1.8', color: '#ccc', fontSize: '15px' }}>
            ...
            <p>By using CreatorFlow Studio™, you agree to these terms. If you do not agree, please do not use our service.</p>

            <h2 style={{ color: 'white', fontSize: '20px', marginTop: '32px' }}>2. Description of Service</h2>
            <p>CreatorFlow Studio™ is an AI-powered creator workflow platform that helps users generate content ideas, scripts, and record videos using our Flow Teleprompter™.</p>
            ...
            <p>You retain ownership of all content you create using CreatorFlow Studio™. We do not claim ownership of your scripts, videos, or ideas.</p>

            <h2 style={{ color: 'white', fontSize: '20px', marginTop: '32px' }}>5. Acceptable Use</h2>
            <p>You agree not to use CreatorFlow Studio™ to create harmful, illegal, or misleading content.</p>
